...
//munculkan/pilih semua data dari table user urutkan dari yang terbesar ke terkecil
                                            ...
                                            foreach ($row as $key => $data): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick="return confirm('are you sure??')" href="user.php?delete=<?php echo $data['id'] ?>"
