...
// ambil data dari inputan, email, nama dan pssword
                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required name="name" type="name" class="form-control" placeholder="Masukkan nama anda.." value="<?= $rowEdit['name'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input required name="email" type="email" class="form-control"
                                                placeholder="Masukkan Email anda.." value="<?= $rowEdit['email'] ?>">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <div class="col-sm-2">
                                        ...
                                        <div class=" mb-3 row">
                                            <div class="col-sm-12">
                                                <button name="<?= isset($_GET['edit']) ? 'edit' : 'simpan'; ?>" type="submit" class="btn btn-primary">
                                                    Simpan
                                                </button>
                                            </div>
                                        </div>
